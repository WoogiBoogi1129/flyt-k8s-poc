...
static int calls;static size_t free_value=123,total_value=456;static cudaError_t error_value=cudaSuccess;
...
int main(void){
    ...
    puts("PASS: memory-info encoding, preflight bounds, CUDA errors and inconsistent observations");
    return 0;
}
